...
vi.mock('@/services/api', () => ({
  api: {
    ...
    integrations: { getAll: vi.fn().mockResolvedValue([]), list: vi.fn().mockResolvedValue([]) },
...
vi.mock('../IntegrationModal', () => ({
  IntegrationModal: ({ integration, onClose }: any) => (
    <div data-testid="integration-modal">{integration.name}</div>
  ),
}));
