...
vi.mock('@/services/geminiService', () => ({
  chatWithComplianceBot: vi.fn().mockResolvedValue('AI response'),
}));
...
describe('ComplianceChat', () => {
  ...
  it('renders the chat toggle button', () => {
    ...
    // The component starts closed, showing the chat bubble icon
    expect(screen.getByTestId('icon-MessageSquare')).toBeInTheDocument();
  });

  it('opens chat when the toggle button is clicked', () => {
