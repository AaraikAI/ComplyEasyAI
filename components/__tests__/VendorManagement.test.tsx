...
vi.mock('@/services/api', () => ({
  api: {
    ...
    vendors: { getAll: vi.fn().mockResolvedValue([]), list: vi.fn().mockResolvedValue([]), getDashboard: vi.fn().mockResolvedValue(null) },
...
describe('VendorManagement', () => {
  ...
  it('renders loading state initially', () => {
    ...
    expect(screen.getByText(/Loading vendor management/i)).toBeTruthy();
  });

  it('renders the vendor management title after loading', async () => {
    render(<VendorManagement onBack={mockOnBack} />);
    await waitFor(() => {
      expect(screen.getByText(/Vendor Management/i)).toBeTruthy();
    });
  });
