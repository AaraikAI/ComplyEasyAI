...
vi.mock('@/hooks/useOnboarding', () => ({
  ...
  useOnboardingChecklist: vi.fn().mockReturnValue({
    items: [
...
vi.mock('@/contexts/OnboardingContext', () => ({
  ...
  useOnboardingContext: vi.fn().mockReturnValue({ isOnboarding: false, currentFlow: null, currentStep: 0, isLoaded: true, showCelebration: false }),
}));
