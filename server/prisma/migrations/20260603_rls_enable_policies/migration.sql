-- =====================================================================
-- 20260603_rls_enable_policies — canonical, prisma-migrate-deploy applied
-- =====================================================================
-- This numbered migration sorts BEFORE 20260604_enforce_rls and is the
-- copy that `prisma migrate deploy` actually applies (loose .sql files
-- directly under prisma/migrations/ are NOT applied by migrate deploy).
-- It establishes the accessor function + ENABLE ROW LEVEL SECURITY + the
-- per-table org_isolation policy that 20260604_enforce_rls then FORCEs.
-- Keep this file and prisma/migrations/rls_policies_all_tables.sql in sync;
-- the loose file is retained only as a standalone reference used by the
