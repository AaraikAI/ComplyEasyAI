  ...
  async createSOXTestResult(data: {
    ...
    const testResult = await prisma.sOXTestResult.create({
      data: {
        ...
        evidence: Object.keys(evidence).length > 0 ? (evidence as Prisma.InputJsonValue) : Prisma.JsonNull,
        deficiencyLevel,
        compensatingControls: data.compensatingControls ? (data.compensatingControls as Prisma.InputJsonValue) : Prisma.JsonNull,
  ...
  async createSOXAssessment(data: {
    ...
    const assessment = await prisma.sOXAssessment.create({
      data: {
        ...
        scopedProcesses: Object.keys(scopedProcesses).length > 0 ? (scopedProcesses as Prisma.InputJsonValue) : Prisma.JsonNull,
        materialAccounts: data.materialAccounts ? (data.materialAccounts as Prisma.InputJsonValue) : Prisma.JsonNull,
        significantLocations: data.significantLocations ? (data.significantLocations as Prisma.InputJsonValue) : Prisma.JsonNull,
        riskAssessment: data.riskAssessment ? (data.riskAssessment as Prisma.InputJsonValue) : Prisma.JsonNull,
        managementCertification: data.managementAssertions ? (data.managementAssertions as Prisma.InputJsonValue) : Prisma.JsonNull,
