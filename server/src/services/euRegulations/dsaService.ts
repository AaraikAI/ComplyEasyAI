  ...
  async conductRiskAssessment(
    ...
    const assessment = await prisma.dSARiskAssessment.create({
      data: {
        ...
        systemicRisks,
        illegalContentRisks: assessmentData.illegalContentRisks || null,
        fundamentalRightsRisks: assessmentData.fundamentalRightsRisks || null,
        publicSecurityRisks: assessmentData.publicSecurityRisks || null,
        protectionOfMinorsRisks: assessmentData.protectionOfMinorsRisks || null,
        overallRiskLevel,
